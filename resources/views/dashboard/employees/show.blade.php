                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <input name="mname_ar" class="form-control" disabled="disabled" type="text"  value="{{$employee->mname_ar}}">
                                                            </div>
                                                            <div class="col-lg-4">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <input name="mname_en" class="form-control" disabled="disabled" type="text"  value="{{$employee->mname_en}}">
                                                            </div>
                                                            <div class="col-lg-4">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="kt-radio-list text-center">
                                                                    <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                        <input type="radio" name="identity_type" disabled="disabled" value="0"   @if($employee->identity_type == 0) checked @endif>
                                                                        {{__('National ID')}}
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                        <input type="radio" name="identity_type" disabled="disabled" value="1"   @if($employee->identity_type == 1) checked @endif>
                                                                        {{__('Iqama')}}
                                                                        <span></span>
                                                                    </label>
                                                                </div>
