    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        ...
        <div class="kt-container  kt-grid__item kt-grid__item--fluid">
            ...
            <div class="kt-portlet kt-margin-top-30">
                ...
                <!--begin::Form-->
                <form class="kt-form" method="POST" action="/dashboard/feedbacks">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" aria-describedby="nameHelp" placeholder="{{ old('name') }}">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    <label>Phone</label>
                                    <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" aria-describedby="nameHelp" placeholder="{{ old('phone') }}">
                                    @error('phone')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" aria-describedby="emailHelp" placeholder="{{ old('email') }}">
                                    @error('email')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="message" class="form-control @error('message') is-invalid @enderror" id="exampleTextarea" rows="3">{{ old('message') }}</textarea>
                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-callout__body">
                                <div class="kt-callout__content">
                                    <h3 class="kt-callout__title">Or Reach Us by Live Chat</h3>
