                        ...
                        swal.fire({
                            ...
                            if (result.value) {
                                ...
                                $.ajax({
                                    ...
                                    url: '/dashboard/departments/' + data.id,
                                    error: function (err) {
                        ...
                        return '\
                          <div class="dropdown">\
                              ...
                              <div class="dropdown-menu dropdown-menu-right">\
                                  <a class="dropdown-item" href="/dashboard/departments/' + row.id + '/edit"><i class="la la-pencil-square-o"></i>' + locator.__('Edit') + '</a>\
                                  <a class="dropdown-item" href="/dashboard/departments/' + row.id + '"><i class="la la-eye"></i>' + locator.__('Show') + '</a>\
