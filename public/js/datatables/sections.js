                        ...
                        swal.fire({
                            ...
                            if (result.value) {
                                ...
                                $.ajax({
                                    ...
                                    url: '/dashboard/sections/' + data.id,
                                    error: function (err) {
                        ...
                        return '\
                          <div class="dropdown">\
                              ...
                              <div class="dropdown-menu dropdown-menu-right">\
                                  <a class="dropdown-item" href="/dashboard/sections/' + row.id + '/edit"><i class="la la-pencil-square-o"></i>' + locator.__('Edit') + '</a>\
                                  <a class="dropdown-item" href="/dashboard/sections/' + row.id + '"><i class="la la-eye"></i>' + locator.__('Show') + '</a>\
