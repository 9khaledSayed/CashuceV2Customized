                        ...
                        swal.fire({
                            ...
                            if (result.value) {
                                ...
                                $.ajax({
                                    ...
                                    url: '/dashboard/job_titles/' + data.id,
                                    error: function (err) {
                        ...
                        return '\
		                  <div class="dropdown">\
		                      ...
		                      <div class="dropdown-menu dropdown-menu-right">\
		                          <a class="dropdown-item" href="/dashboard/job_titles/' + row.id + '/edit"><i class="la la-pencil-square-o"></i>' + locator.__('Edit Info') + '</a>\
		                      </div>\
		                  </div>\
                        ';
                    }
